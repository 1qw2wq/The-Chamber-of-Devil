                  ...
                  <div className="rounded-2xl border border-[#21232c] bg-[#0c1015] p-6 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="space-y-4 md:max-w-[40%]">
                      ...
                      <div className="flex flex-wrap gap-3 pt-2">
                        <div className="flex items-center gap-1.5 text-[11px] text-orange-400 font-semibold bg-orange-950/20 px-2.5 h-6 rounded-md border border-orange-900/30">
                          <span className="w-2 h-2 rounded-full bg-orange-500 shrink-0" />
                          <span className="leading-none pt-[0.5px]">{revealedBulletCount.live} Live Gold</span>
                        </div>
                        <div className="flex items-center gap-1.5 text-[11px] text-slate-400 font-semibold bg-slate-900/50 px-2.5 h-6 rounded-md border border-gray-800">
                          <span className="w-2 h-2 rounded-full bg-slate-400 shrink-0" />
                          <span className="leading-none pt-[0.5px]">{revealedBulletCount.blank} silver Blanks</span>
                        </div>
                      </div>
                          ...
                          <div className="flex flex-wrap gap-1.5 max-h-16 overflow-y-auto pr-1">
                            {expendedBullets.map((bullet, idx) => {
                              ...
                              return (
                                <span 
                                  key={idx}
                                  className={`inline-flex items-center gap-1 px-1.5 h-5 rounded text-[9px] font-mono font-bold select-none transition-transform hover:scale-105 border ${
                                    isDiscarded
                                ...
                                >
                                  <span className="flex items-center justify-center w-3 h-3 text-[10px] leading-none shrink-0" aria-hidden="true">
